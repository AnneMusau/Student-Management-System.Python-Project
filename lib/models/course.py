...
class Course:
    ...
    def __repr__(self):
        return f"Course Title: {self.course_title}, Duration: {self.course_duration} hours"
    ...
    def set_course_title(self, course_title):
        if isinstance(course_title, str) and len(course_title) > 0:
            ...
            raise ValueError("Course title is not valid!")
    ...
    def set_course_duration(self, course_duration):
        if isinstance(course_duration, int) and course_duration > 0:
            ...
            raise ValueError("Course duration is not valid!")
